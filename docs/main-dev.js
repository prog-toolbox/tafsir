...
/** @constructor */
function $c_Ltb_oss_tafsir_Main$() {
}
$c_Ltb_oss_tafsir_Main$.prototype = new $h_O();
$c_Ltb_oss_tafsir_Main$.prototype.constructor = $c_Ltb_oss_tafsir_Main$;
/** @constructor */
function $h_Ltb_oss_tafsir_Main$() {
}
$h_Ltb_oss_tafsir_Main$.prototype = $c_Ltb_oss_tafsir_Main$.prototype;
$c_Ltb_oss_tafsir_Main$.prototype.main__AT__V = (function(args) {
  var node = document.createElement("div");
  node.textContent = "Tafsir";
  document.body.appendChild(node);
});
var $d_Ltb_oss_tafsir_Main$ = new $TypeData().initClass($c_Ltb_oss_tafsir_Main$, "tb.oss.tafsir.Main$", ({
  Ltb_oss_tafsir_Main$: 1
}));
var $n_Ltb_oss_tafsir_Main$;
function $m_Ltb_oss_tafsir_Main$() {
  if ((!$n_Ltb_oss_tafsir_Main$)) {
...
$L0 = new $c_RTLong(0, 0);
$d_J.zero = $L0;
$s_Ltb_oss_tafsir_Main__main__AT__V(new ($d_T.getArrayOf().constr)([]));
}).call(this);
